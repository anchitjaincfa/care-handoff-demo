...
CSV export is delivered as a ZIP containing events.csv plus PROVENANCE.txt. The provenance notice states that data is self-reported, unverified, generated locally, and not a clinical record.
