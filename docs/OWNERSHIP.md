...
CSV export is delivered as an export-only ZIP containing events.csv plus PROVENANCE.txt; JSON backup is the supported restore format. The provenance notice states that data is self-reported, unverified, generated locally, and not a clinical record.
