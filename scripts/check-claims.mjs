...
const violations=[]; for(const file of await files("src/copy")){ const text=await readFile(file,"utf8"); for(const p of patterns) if(p.test(text)) violations.push(`${file}: ${p}`); }
