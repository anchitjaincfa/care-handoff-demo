...
export const SURFACE_CAPABILITIES: Capability[] = [
  ...
  { id:"professional-roster-research", label:"Professional roster research preview", status:"preview", reason:"Explores demand using synthetic data only.", dataScope:"demo-local" },
