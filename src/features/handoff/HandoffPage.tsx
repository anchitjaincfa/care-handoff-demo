...
function artifactSize(byteCount: number, byteLimit: number) {
  return `${byteCount.toLocaleString()} ${COPY.live.bytesUnit} ${COPY.live.ofLabel} ${byteLimit.toLocaleString()} ${COPY.live.bytesUnit}`;
}
